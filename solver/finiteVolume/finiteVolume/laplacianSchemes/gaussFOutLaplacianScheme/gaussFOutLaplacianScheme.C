...
tmp<fvMatrix<Type>>
gaussFOutLaplacianScheme<Type, GType>::fvmLaplacianUncorrected
(
...
gaussFOutLaplacianScheme<Type, GType>::gammaSnGradCorr
(
...
gaussFOutLaplacianScheme<Type, GType>::fvcLaplacian
(
    const GeometricField<Type, fvPatchField, volMesh>& vf
)
{
...
template<class Type, class GType>
tmp<fvMatrix<Type>>
gaussFOutLaplacianScheme<Type, GType>::fvmLaplacian
(
...
template<class Type, class GType>
tmp<GeometricField<Type, fvsPatchField, surfaceMesh>>
gaussFOutLaplacianScheme<Type, GType>::fvcLaplacianGrad
(
    const GeometricField<GType, fvsPatchField, surfaceMesh>& gamma,
    const GeometricField<Type, fvPatchField, volMesh>& vf
)
