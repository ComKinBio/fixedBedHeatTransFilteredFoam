...
#include "gaussFOutLaplacianScheme.H"
#include "fvMesh.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

makeFvLaplacianScheme2(gaussFOutLaplacianScheme)

#define declareFvmLaplacianScalarGamma(Type)                                   \
                                                                               \
template<>                                                                     \
Foam::tmp<Foam::fvMatrix<Foam::Type>>                                          \
Foam::fv::gaussFOutLaplacianScheme<Foam::Type, Foam::scalar>::fvmLaplacian         \
(                                                                              \
...
Foam::fv::gaussFOutLaplacianScheme<Foam::Type, Foam::scalar>::fvcLaplacian         \
(                                                                              \
    const GeometricField<scalar, fvsPatchField, surfaceMesh>& gamma,           \
    const GeometricField<Type, fvPatchField, volMesh>& vf                      \
)                                                                              \
{                                                                              \
    ...
    return tLaplacian;                                                         \
                                                                               ...
                                                                               \
template<>                                                                     \
Foam::tmp<Foam::GeometricField<Foam::Type, Foam::fvsPatchField, Foam::surfaceMesh>>\
Foam::fv::gaussFOutLaplacianScheme<Foam::Type, Foam::scalar>::fvcLaplacianGrad \
(                                                                              \
    const GeometricField<scalar, fvsPatchField, surfaceMesh>& gamma,           \
    const GeometricField<Type, fvPatchField, volMesh>& vf                      \
)                                                                              \
{                                                                              \
    const fvMesh& mesh = this->mesh();                                         \
                                                                               \
    tmp<GeometricField<Type, fvsPatchField, surfaceMesh>> tLaplacian               \
    (                                                                          \
        gamma*this->tsnGradScheme_().snGrad(vf)*mesh.magSf()                   \
    );                                                                         \
                                                                               \
    tLaplacian.ref().rename                                                    \
    (                                                                          \
