...
Foam::scalar Foam::PairCollisionHeat<CloudType>::cosPhiMinFlatWall = 1 - small;

template<class CloudType>
Foam::scalar Foam::PairCollisionHeat<CloudType>::flatWallDuplicateExclusion =
    sqrt(3*small);
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::preInteraction()
{
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::preInteractionHeat()
{
    // Set accumulated quantities to zero
    forAllIter(typename CloudType, this->owner(), iter)
    {
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::parcelInteraction()
{
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::parcelInteractionHeat()
{
    PstreamBuffers pBufs(Pstream::commsTypes::nonBlocking);
    ...
    realRealInteractionHeat();

    il_.receiveReferredData(pBufs, startOfRequests);

    realReferredInteractionHeat();
  
}


template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::realRealInteraction()
{
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::realReferredInteraction()
{
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::realRealInteractionHeat()
{
    // Direct interaction list (dil)
    const labelListList& dil = il_.dil();
        ...
        forAll(cellOccupancy[realCelli], a)
        {
            ...
            forAll(dil[realCelli], interactingCells)
            {
                ...
                forAll(cellBParcels, b)
                {
                    ...
                    evaluatePairHeat(*pA_ptr, *pB_ptr);
                }
            }
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::realReferredInteractionHeat()
{
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::wallInteraction()
{
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::wallInteractionHeat()
{
    const polyMesh& mesh = this->owner().mesh();
...
template<class CloudType>
bool Foam::PairCollisionHeat<CloudType>::duplicatePointInList
(
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::postInteraction()
{
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::evaluatePair
(
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::evaluatePairHeat
(
    typename CloudType::parcelType& pA,
    typename CloudType::parcelType& pB
) const
{
    pairModel_->evaluatePairHeat(pA, pB);
}



template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::evaluateWall
(
    typename CloudType::parcelType& p,
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::evaluateWallHeat
(
    typename CloudType::parcelType& p,
    const List<point>& flatSitePoints,
    const List<WallSiteData<vector>>& flatSiteData,
...
template<class CloudType>
Foam::PairCollisionHeat<CloudType>::PairCollisionHeat
(
...
Foam::PairCollisionHeat<CloudType>::PairCollisionHeat
(
    const PairCollisionHeat<CloudType>& cm
)
:
...
template<class CloudType>
Foam::label Foam::PairCollisionHeat<CloudType>::nSubCycles() const
{
    label nSubCycles = 1;
...
// std::cout<<"on processor: "<<Pstream::myProcNo()<<' '<<" nPairSubCycles"<<nPairSubCycles<<'\n';
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::collide()
{
    preInteraction();
...
template<class CloudType>
void Foam::PairCollisionHeat<CloudType>::collideHeat()
{
    preInteractionHeat();
    
    parcelInteractionHeat();
